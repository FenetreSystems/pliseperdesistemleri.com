...
export default function Dealership() {
  return (
    <>
      <Head>
        <title>Bayilik Programı - Plise Perde Sistemleri</title>
        <meta name="description" content="Plise Perde Sistemleri bayilik programı - Kazançlı bir iş kurmak için ortağımız olun." />
        <meta name="keywords" content="bayilik, plise perde bayisi, iş ortaklığı, dağıtıcı" />
