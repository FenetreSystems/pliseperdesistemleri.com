      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/905403363873" className="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center hover:bg-primary transition text-primary hover:text-secondary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 py-8 border-t border-gray-700">
          ...
          <div>
            ...
            <a href="https://wa.me/905403363873" className="text-gray-300 hover:text-primary transition font-semibold">
              +90 540 336 3873
            </a>
